...
#include "ui_dialogevolucion.h"

DialogEvolucion::DialogEvolucion(Peer *mainPeer, QByteArray uid, QString nombre, QString ips, QString cp) : ui(new Ui::DialogEvolucion), peer(mainPeer)
{
    ui->setupUi(this);
...
DialogEvolucion::~DialogEvolucion()
{
    delete ui;
}

void DialogEvolucion::createHealthRecord(QFile *file)
{
    ...
    else
    {
        ...
        out<<"ANALISIS SUBJETIVO : ";
        out<<ui->plainTextEdit_Subjetivo->toPlainText()+"\n";

        out<<"ANALISIS OBJETIVO : ";
        out<<ui->plainTextEdit_Objetivo->toPlainText()+"\n";
...
void DialogEvolucion::on_commandLinkButton_clicked()
{
    ...
    //close dialog
    QMessageBox::information(this, "OK :)","Evolucion añadida satisfactoriamente!");
